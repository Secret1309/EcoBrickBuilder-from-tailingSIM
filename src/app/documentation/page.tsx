            ...
            <main className="container mx-auto max-w-5xl px-4 py-12">
                ...
                <div className="mb-10">
                    ...
                    <p className="mt-4 text-lg text-eco-600">
                        Penjelasan lengkap mengenai algoritma, model neraca massa, stoikiometri netralisasi, dan analisis tekno-ekonomi yang digunakan dalam Eco-Brick Simulator untuk upcycling limbah tailing industri.
                    </p>
                </div>
                ...
                <div className="space-y-12">
                    ...
                    <section className="rounded-2xl border bg-white p-8 shadow-sm">
                        ...
                        <div className="space-y-6">
                                ...
                                <table className="w-full text-sm">
                                    ...
                                    <tbody className="divide-y">
                                        ...
                                        <tr>
                                            ...
                                            <td className="px-4 py-3 text-gray-600">Rp 2,16 Miliar/tahun (UMK Daerah Sekitar Industri Nikel × 20 orang)</td>
                                        </tr>
                                        <tr>
                            ...
                            <div className="rounded-lg bg-eco-50 p-4 text-sm text-eco-800 border border-eco-200">
                                <strong>Catatan:</strong> Limbah tailing HPAL diasumsikan gratis (Rp 0/ton) karena merupakan limbah industri.
                                Bahkan, pabrik menerima <strong>Tipping Fee</strong> sebesar Rp 75.000/ton dari Kawasan Industri untuk menerima tailing, menjadikan bahan baku justru menghasilkan pendapatan.
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="rounded-2xl border bg-white p-8 shadow-sm">
                        <h2 className="mb-6 flex items-center gap-3 text-2xl font-bold text-gray-900">
                            ...
                            Parameter Kalkulator BUMDes (Konteks Daerah Sekitar Industri Nikel)
                        </h2>
                        <div className="space-y-8">
                            ...
                            {/* Tabel 3 - Harga Daerah Sekitar */}
                            <div>
                                <h3 className="mb-3 text-lg font-semibold text-gray-800">Tabel 3: Database Harga Eceran Komponen OPEX (Konteks Daerah Sekitar Industri Nikel)</h3>
                                <div className="overflow-hidden rounded-lg border">
                                    <table className="w-full text-sm text-left">
                                        <thead className="bg-gray-50 border-b">
                                            <tr>
                                                ...
                                                <th className="px-4 py-3 font-semibold text-gray-700">Harga Estimasi (Daerah Sekitar)</th>
                                        ...
                                        <tbody className="divide-y">
                                            <tr>
                                                ...
                                                <td className="px-4 py-3 text-gray-600">Disuplai industri nikel</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td className="px-4 py-3 text-gray-600">Sungai daerah sekitar industri nikel</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                    ...
                    <section className="rounded-2xl border bg-white p-8 shadow-sm">
                        <h2 className="mb-6 flex items-center gap-3 text-2xl font-bold text-gray-900">
                            ...
                            Daftar Pustaka (Referensi Ilmiah Paper GSC 2026)
                        </h2>
                        <div className="space-y-8">

                            <div>
                                <h3 className="mb-3 text-lg font-semibold text-eco-800 border-l-4 border-eco-400 pl-3">Geopolimer &amp; Material Konstruksi Berbasis Limbah</h3>
                                <ul className="list-disc space-y-3 pl-5 text-sm text-gray-700">
                                    <li>
                                        <strong>Longos, A., Tigue, A.A., Dollente, I.J., Malenab, R.A., Bernardo-Arugay, I., Hinode, H., Kurniawan, W. &amp; Promentilla, M.A.</strong> (2020).
                                        Optimization of the mix formulation of geopolymer using nickel-laterite mine waste and coal fly ash. <em>Minerals</em>, 10(12), p. 1144.
                                        doi: 10.3390/min10121144.
                                    </li>
                                    <li>
                                        <strong>Ahmari, S. &amp; Zhang, L.</strong> (2013). Durability and leaching behavior of mine tailings-based geopolymer bricks.
                                        <em> Construction and Building Materials</em>, 44, pp. 743–750. doi: 10.1016/j.conbuildmat.2013.03.075.
                                    </li>
                                    <li>
                                        <strong>Provis, J.L. &amp; van Deventer, J.S.J. (eds.)</strong> (2009). <em>Geopolymers: Structures, Processing, Properties and Industrial Applications</em>.
                                        Cambridge: Woodhead Publishing.
                                    </li>
                                    <li>
                                        <strong>Halim, N., Minwal, W.P. &amp; Muhammad, F.</strong> (2024). <em>Script Metallurgical Process Engineering Chapter: Extractive Metallurgy</em>.
                                        Bandung: Program Studi Teknik Metalurgi ITB.
                                    </li>
                                </ul>
                            </div>

                            <div>
                                <h3 className="mb-3 text-lg font-semibold text-eco-800 border-l-4 border-eco-400 pl-3">Hidrometalurgi HPAL &amp; Tailing Nikel Laterit</h3>
                                <ul className="list-disc space-y-3 pl-5 text-sm text-gray-700">
                                    <li>
                                        <strong>Mubarok, M.Z., Minwal, W.P. &amp; Tanlega, Z.</strong> (2026). <em>Handout Kuliah MG-3215 Hidro-elektrometalurgi: Bab VIII Proses Ekstraksi Nikel dari
                                        Bijih Laterit dengan Jalur Hidrometalurgi</em>. Bandung: Program Studi Teknik Metalurgi ITB.
                                    </li>
                                    <li>
                                        <strong>Crundwell, F., Moats, M., Ramachandran, V., Robinson, T. &amp; Davenport, W. G.</strong> (2011).
                                        <em> Extractive Metallurgy of Nickel, Cobalt and Platinum Group Metals</em>. Oxford: Elsevier.
                                    </li>
                                    <li>
                                        <strong>Li, G., Xiong, X., Wang, L. &amp; Peng, J.</strong> (2017). Utilization of laterite nickel ore HPAL tailings for cement-based material production.
                            ...
                            <div>
                                <h3 className="mb-3 text-lg font-semibold text-eco-800 border-l-4 border-eco-400 pl-3">Decision Support System &amp; LCA</h3>
                                <ul className="list-disc space-y-3 pl-5 text-sm text-gray-700">
                                    <li>
                                        <strong>Jadid, M.N.</strong> (2013). Development of a web-based decision support system for materials selection in construction engineering.
                                        <em> International Journal of Civil Engineering and Technology</em>, 4(2), pp. 177–188.
                                    </li>
                                    <li>
                                        <strong>Turban, E., Sharda, R. &amp; Delen, D.</strong> (2011). <em>Decision Support and Business Intelligence Systems</em>. 9th edn. Boston: Pearson.
                                    </li>
                                    <li>
                                        <strong>Zhang, J., Fernando, S., Law, D.W., Gunasekara, C., Setunge, S., Sandanayake, M. &amp; Zhang, G.</strong> (2023).
                                        Life cycle assessment for geopolymer concrete bricks using brown coal fly ash. <em>Sustainability</em>, 15(9), p. 7718.
                            ...
                            <div>
                                <h3 className="mb-3 text-lg font-semibold text-eco-800 border-l-4 border-eco-400 pl-3">Standar Mutu &amp; Regulasi Lingkungan</h3>
                                <ul className="list-disc space-y-3 pl-5 text-sm text-gray-700">
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        Lampiran XI: Baku Mutu TCLP. Jakarta: Sekretariat Negara.
                                    </li>
                                    <li>
