            ...
            <div className="bg-green-800 px-4 py-16 text-center text-white sm:px-6 lg:px-8">
                <div className="mx-auto max-w-3xl">
                    ...
                    <p className="mt-4 text-lg text-green-100">
                        Platform panduan praktis untuk mengubah limbah tailing HPAL nikel laterit menjadi produk batako & paving block bernilai ekonomi. Dirancang khusus untuk BUMDes di daerah sekitar industri nikel.
                    </p>
                </div>
            </div>
                                        ...
                                        <div className="rounded-lg bg-blue-50 p-4 border border-blue-100 flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="mt-1 text-xs text-blue-800 leading-relaxed">
                                                    Fotokan produk yang sudah mengeras dan upload ke sistem <strong>Green Product Showcase</strong>. Industri nikel dan pemerintah daerah sekitar industri nikel memantau katalog komunitas secara berkala untuk pembelian grosir infrastruktur kawasan industri.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
